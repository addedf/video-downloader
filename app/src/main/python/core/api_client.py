...
class DouyinAPIClient:
    ...
    async def _ensure_ms_token(self) -> str:
        ...
        token = await loop.run_in_executor(None, self._ms_token_manager.ensure_ms_token, self.cookies)
    ...
    async def collect_user_post_ids_via_browser(
        ...
        *,
        ...
        logger.info(
            "Browser fallback disabled in Android Chaquopy build for sec_uid=%s",
            sec_uid,
        )
        return []
