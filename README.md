...
<p align="center">
  <a href="README.en.md">English</a> · <a href="https://github.com/addedf/video-downloader/releases/tag/v2.0.0">下载 v2.0.0</a>
</p>
...
以下截图来自仓库中的 [v2 UI 对齐原型](docs/app-ui-prototype.html)，用于呈现当前的交互状态和视觉方向。
